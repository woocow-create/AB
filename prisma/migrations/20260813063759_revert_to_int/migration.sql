/*
  ...
  - You are about to alter the column `requiredBudgetKrw` on the `SimulationResult` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Int`.
  - You are about to alter the column `requiredImpressionsPerArm` on the `SimulationResult` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Int`.
